...
class Indents(BaseModel):
    ...
    indent_from = models.CharField(max_length=255, null=True)
    indent_to = models.CharField(max_length=255, null=True)
    export_to = models.CharField(max_length=255, null=True)
