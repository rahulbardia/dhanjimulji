...
class Supplier(BaseModel):
    ...
    gst_no = models.CharField(max_length=15, null=True)
    pan_no = models.CharField(max_length=10, null=True)
    commission_percentage = models.FloatField(null=True)
...
class SupplierInventory(BaseModel):
    ...
    sort_no = models.CharField(max_length=255, null=True)
    packing = models.IntegerField(null=True)
    size = models.IntegerField(null=True)
    rate = models.FloatField(null=True)
    cuts = models.IntegerField(null=True)
